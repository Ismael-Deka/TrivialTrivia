...
public class MainActivity extends AppCompatActivity implements MasterListFragment.OnItemClickListener,
                                                        ...
                                                        QuestionLoaderCallback.OnQuestionLoaderCompleteListener, TriviaQuestionFragment.OnGameFinishedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(findViewById(R.id.trivia_fragment_tablet) != null){
            mTwoPane = true;
            getSupportFragmentManager().beginTransaction().add(R.id.master_list_fragment,mMasterListFragment)
                    .commit();
